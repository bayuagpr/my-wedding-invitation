...
export default function BackgroundMusic() {
  ...
  return (
    <>
      ...
      <Button
        onClick={toggleMusic}
        className="fixed bottom-20 md:bottom-24 right-4 z-50 bg-background/80 backdrop-blur-sm p-3 rounded-full shadow-lg border border-white/10 hover:bg-background/90 hover:scale-105 transition-all duration-300"
      >
